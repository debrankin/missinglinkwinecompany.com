...
$USA = mysql_query($query_USA, $admin) or die(mysql_error());
$row_USA = mysql_fetch_assoc($USA);
$totalRows_USA = mysql_num_rows($USA);
...
<div class="label"><a href="#"><img src="images/logos/<?php echo $row_Argentina['logo']; ?>.png" height=""  alt="" class="scalable"/></a> </div>
      ...
      <div style="margin-bottom:10px;" class="content">
        ...
        <p></p>
        <?php } while ($row_USA = mysql_fetch_assoc($USA)); ?>
