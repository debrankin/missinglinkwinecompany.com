...
$body = "<html><body>" .
		...
		"http://missinglinkwinecompany.com/test/activate.php?activation=".$my_activation."".
		"";
$headers = 	"From: Missing Link Wine Company: Account Activation <contact@missinglinkwinecompany.com>\r\n" . 
			"MIME-Version: 1.0\r\n" .
