...
$rs_producer_details = mysqli_query( $admin, $query_rs_producer_details) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_rs_producer_details = mysqli_fetch_assoc($rs_producer_details);
$totalRows_rs_producer_details = mysqli_num_rows($rs_producer_details);
...
$rs_join = mysqli_query( $admin, $query_rs_join) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_rs_join = mysqli_fetch_assoc($rs_join);
$totalRows_rs_join = mysqli_num_rows($rs_join);
      ...
      <div class="main-content-wide">
        <div class="content p7ehc-1">
          ...
          <div class="repeatregion">
            ...
            <div class="wines"><?php do { ?><div class="wine-details"><?php echo $row_rs_join['wines']; ?></div><?php } while ($row_rs_join = mysqli_fetch_assoc($rs_join)); ?></div>
            <p><br clear="all" />
            </p>
          </div>
<br clear="all" />
...
<!-- InstanceEnd --></html>
<?php
((mysqli_free_result($rs_producer_details) || (is_object($rs_producer_details) && (get_class($rs_producer_details) == "mysqli_result"))) ? true : false);
