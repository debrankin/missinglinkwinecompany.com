...
$rs_wine_details = mysql_query($query_rs_wine_details, $admin) or die(mysql_error());
$row_rs_wine_details = mysql_fetch_assoc($rs_wine_details);
$totalRows_rs_wine_details = mysql_num_rows($rs_wine_details);
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rs_wine_details);
