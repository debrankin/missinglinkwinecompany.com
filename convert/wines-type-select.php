...
$query_Recordset1 = sprintf("SELECT * FROM wines WHERE type = %s ORDER BY wines ASC", GetSQLValueString($colname_Recordset1, "text"));
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
    ...
    <div class="main-content-wide">
        <div class="content p7ehc-1">  <div class="select-country-hdr">
  <h2 style="margin-top:0px;" id="<?php echo $row_Recordset1['type']; ?>"><?php echo $row_Recordset1['type']; ?></h2>
        </div>
          <?php do { ?>
            <div class="wine-box">
              <div class="wine-blt"><img src="images/logos/<?php echo $row_Recordset1['bottle_img']; ?>" height=""  alt="" class="scalable"/></div>
              <a href="wines-detail.php?recordID=<?php echo $row_Recordset1['code']; ?>"><?php echo $row_Recordset1['wines']; ?></a><br>
              <?php echo $row_Recordset1['type']; ?><br>
              <?php echo $row_Recordset1['year']; ?> <?php echo $row_Red['producer']; ?><br>
            </div>
...
<!-- InstanceEnd --></html>
<?php
((mysqli_free_result($Recordset1) || (is_object($Recordset1) && (get_class($Recordset1) == "mysqli_result"))) ? true : false);
?>
