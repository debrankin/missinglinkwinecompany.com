...
$colname_rs_wine_details = "-1";
if (isset($_GET['recordID'])) {
  $colname_rs_wine_details = $_GET['recordID'];
}
...
$query_rs_wine_details = sprintf("SELECT * FROM wines WHERE code = %s ORDER BY wines ASC", GetSQLValueString($colname_rs_wine_details, "text"));
$rs_wine_details = mysqli_query( $admin, $query_rs_wine_details) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_rs_wine_details = mysqli_fetch_assoc($rs_wine_details);
$totalRows_rs_wine_details = mysqli_num_rows($rs_wine_details);
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
      ...
      <div class="main-content-wide">
        <div class="content p7ehc-1">
          <h2><?php echo $row_rs_wine_details['wines']; ?></h2>
          <div class="repeatregion">
            <div class="producer"></div>
            <div class="label"><img src="images/logos/<?php echo $row_rs_wine_details['bottle_img']; ?>" class="scalable">Full bottle image or lable</div>
            <div style="width: 65%; float: left;">
              <p><?php echo $row_rs_wine_details['description']; ?></p>
              <p><?php echo $row_rs_wine_details['producer']; ?></p>
              <p><?php echo $row_rs_wine_details['code']; ?></p>
            </div>
            <p>&nbsp;</p>
            <br clear="all" /><p>&nbsp;</p>
            <div class="wines"></div>
...
<!-- InstanceEnd --></html>
<?php
((mysqli_free_result($rs_wine_details) || (is_object($rs_wine_details) && (get_class($rs_wine_details) == "mysqli_result"))) ? true : false);
