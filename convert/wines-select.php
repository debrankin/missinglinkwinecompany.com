...
$Recordset1 = mysqli_query( $admin, $query_Recordset1) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
</div><?php } while ($row_Recordset1 = mysqli_fetch_assoc($Recordset1)); ?>
<br clear="all" />
      </div>
      </div>
