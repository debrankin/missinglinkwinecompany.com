...
if (isset($_POST['username2'])) {
  ...
  ((bool)mysqli_query( $clients, "USE $database_clients"));
      
  $LoginRS__query=sprintf("SELECT username, password, level FROM `admin` WHERE username=%s AND password=%s",
  GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysqli_query( $clients, $LoginRS__query) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  ((bool)mysqli_query( $clients, "USE $database_clients"));
  $Result1 = mysqli_query( $clients, $insertSQL) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
<div class="content-wrapper">  <div class="masthead">
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
   ...
   <h2>Login </h2>
   <div class="login-error">That user name is already registered, please  login or  register with different user name.&nbsp;</div>
  ...
  <tr>
    ...
    <td><input type="text" name="username2" id="username" /></td>
  </tr>
  <tr>
          ...
          <div style="margin-top:15px;">
            <table align="center" width="98%">
              <tr valign="baseline">
                          ...
                          <td align="left"><input type="text" name="name" value="" size="18" /></td>
              </tr>
                        <tr valign="baseline">
                          <td nowrap="nowrap" align="left">Email:</td>
                          <td align="left"><input type="text" name="email" value="" size="18" /></td>
                        </tr>
                        <tr valign="baseline">
                        ...
                        <tr valign="baseline">
                          ...
                          <td align="left"><input type="password" name="password" value="" size="18" /></td>
                        </tr>
                        <tr valign="baseline">
