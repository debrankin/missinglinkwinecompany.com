...
$query_Recordset1 = sprintf("SELECT * FROM producers WHERE country = %s ORDER BY producer ASC", GetSQLValueString($colname_Recordset1, "text"));
...
<div class="columns-wrapper">
        ...
        <div class="content p7ehc-1">
          ...
          <div class="prod-menu" style="margin-top:20px;">
            <div class="country"><a href="producers.php">ALL</a></div>
            <div class="flag"><a href="producers.php"><img src="images/peace2.png" width="23" height="17"  alt=""/></a></div>
            <div class="clearfloat"></div>
          </div>
          <?php do { ?>
          <div class="prod-menu">
            <div class="country"><a href="producers-select.php?country=<?php echo $row_country_menu['country']; ?>"><?php echo $row_country_menu['country']; ?></a></div>
      ...
      <div class="main-content-wide">
        <div class="content p7ehc-1">
          <h2>Producers<br /> from <?php echo $row_Recordset1['country']; ?></h2>
          <?php do { ?>
       
          <div class="repeatregion">  <div class="producer"><a href="producers-detail.php?recordID=<?php echo $row_Recordset1['id']; ?>"><?php echo $row_Recordset1['producer']; ?></a></div>
            
              <div class="label"><a href="#"><img src="images/logos/<?php echo $row_Recordset1['logo']; ?>.png" height=""  alt="" class="scalable"/></a> </div>
              <div style="width: 65%; float: left;"><?php echo $row_Recordset1['description']; ?></div>
              <br clear="all" />
            </div>
