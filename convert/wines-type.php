...
$Red = mysqli_query( $admin, $query_Red) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_Red = mysqli_fetch_assoc($Red);
$totalRows_Red = mysqli_num_rows($Red);

((bool)mysqli_query( $admin, "USE $database_admin"));
$query_White = "SELECT * FROM wines WHERE type LIKE '%White%' ORDER BY wines ASC";
$White = mysqli_query( $admin, $query_White) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_White = mysqli_fetch_assoc($White);
$totalRows_White = mysqli_num_rows($White);

((bool)mysqli_query( $admin, "USE $database_admin"));
$query_Sparkling = "SELECT * FROM wines WHERE type LIKE '%Sparkling%' ORDER BY wines ASC";
$Sparkling = mysqli_query( $admin, $query_Sparkling) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_Sparkling = mysqli_fetch_assoc($Sparkling);
$totalRows_Sparkling = mysqli_num_rows($Sparkling);

((bool)mysqli_query( $admin, "USE $database_admin"));
$query_Rose = "SELECT * FROM wines WHERE type LIKE '%Rose%' ORDER BY wines ASC";
$Rose = mysqli_query( $admin, $query_Rose) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_Rose = mysqli_fetch_assoc($Rose);
$totalRows_Rose = mysqli_num_rows($Rose);

((bool)mysqli_query( $admin, "USE $database_admin"));
$query_Dessert = "SELECT * FROM wines WHERE type LIKE '%Dessert%' ORDER BY wines ASC";
$Dessert = mysqli_query( $admin, $query_Dessert) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_Dessert = mysqli_fetch_assoc($Dessert);
$totalRows_Dessert = mysqli_num_rows($Dessert);

((bool)mysqli_query( $admin, "USE $database_admin"));
$query_Spirit = "SELECT * FROM wines WHERE type LIKE '%Spirit%' ORDER BY wines ASC";
$Spirit = mysqli_query( $admin, $query_Spirit) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
$row_Spirit = mysqli_fetch_assoc($Spirit);
$totalRows_Spirit = mysqli_num_rows($Spirit);
...
<div class="content-wrapper">  <div class="masthead">
 ...
 <div class="columns-wrapper">     <div class="sidebar" id="clinks">
    <div class="content p7ehc-1">
      ...
      <h2>Wines by Type </h2>
      <div class="prod-menu" style="margin-top:20px;">
        <div class="country" ><a href="wines-type.php#all">ALL</a></div>
        <div class="flag"><a href="producers.php"><img src="images/peace2.png" width="23" height="17"  alt=""/></a></div>
        <div class="clearfloat"></div>
      </div>
      <?php do { ?>
      <div class="prod-menu">
        <div class="country"><a href="wines-type-select.php?recordID=<?php echo $row_type_menu['type']; ?>#<?php echo $row_type_menu['type']; ?>"><?php echo $row_type_menu['type']; ?></a></div>
 ...
 <div class="main-content-wide">
  ...
  <h2 style="margin-top:0px;" id="all"><?php echo $row_Red['type']; ?></h2>
        </div>
        
         <div class="wine-container"><?php do { ?>
<div class="wine-box">
  <div class="wine-blt"><img src="images/logos/<?php echo $row_Red['bottle_img']; ?>" height=""  alt="" class="scalable"/></div> 
  <a href="wines-detail.php?recordID=<?php echo $row_Red['code']; ?>"><?php echo $row_Red['wines']; ?></a><br> <?php echo $row_Red['type']; ?><br>
            <?php echo $row_Red['year']; ?>
            <?php echo $row_Red['producer']; ?><br>
</div><?php } while ($row_Red = mysqli_fetch_assoc($Red)); ?>
<br clear="all" /> </div>
          </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
          <h2 style="margin-bottom:0px;"><?php echo $row_White['type']; ?></h2>
        </div>
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><img src="images/logos/<?php echo $row_White['bottle_img']; ?>" height=""  alt="" class="scalable"/></div>
          <a href="wines-detail.php?recordID=<?php echo $row_White['code']; ?>"><?php echo $row_White['wines']; ?></a><br>
          <?php echo $row_White['type']; ?><br>
          <?php echo $row_White['year']; ?><br>
          <?php echo $row_White['producer']; ?><br>
        </div>
        <?php } while ($row_White = mysqli_fetch_assoc($White)); ?>
        <br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
          <h2 style="margin-bottom:0px;"><?php echo $row_Rose['type']; ?></h2>
        </div>
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><img src="images/logos/<?php echo $row_Rose['bottle_img']; ?>" height=""  alt="" class="scalable"/></div>
          <a href="wines-detail.php?recordID=<?php echo $row_Rose['code']; ?>"><?php echo $row_Rose['wines']; ?></a><br>
          <?php echo $row_Rose['type']; ?><br>
          <?php echo $row_Rose['year']; ?><br>
          <?php echo $row_Rose['producer']; ?><br>
        </div>
        <?php } while ($row_Rose = mysqli_fetch_assoc($Rose)); ?>
        <br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
          <h2 style="margin-bottom:0px;"><?php echo $row_Sparkling['type']; ?></h2>
        </div>
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><img src="images/logos/<?php echo $row_Sparkling['bottle_img']; ?>" height=""  alt="" class="scalable"/></div>
          <a href="wines-detail.php?recordID=<?php echo $row_Sparkling['code']; ?>"><?php echo $row_Sparkling['wines']; ?></a><br>
          <?php echo $row_Sparkling['type']; ?><br>
          <?php echo $row_Sparkling['year']; ?><br>
          <?php echo $row_Sparkling['producer']; ?><br>
        </div>
        <?php } while ($row_Sparkling = mysqli_fetch_assoc($Sparkling)); ?>
        <br clear="all" />
      </div>
   
      <div style="margin-bottom:10px;" class="content"><div class="select-country-hdr">
        <h2 style="margin-bottom:0px;"><?php echo $row_Dessert['type']; ?></h2></div>
        <div class="wine-container">
          <?php do { ?>
          <div class="wine-box">
            <div class="wine-blt"><img src="images/logos/<?php echo $row_Dessert['bottle_img']; ?>" height=""  alt="" class="scalable"/></div>
            <a href="wines-detail.php?recordID=<?php echo $row_Dessert['code']; ?>"><?php echo $row_Dessert['wines']; ?></a><br>
            <?php echo $row_Dessert['type']; ?><br>
            <?php echo $row_Dessert['year']; ?><br> 
            <?php echo $row_Dessert['producer']; ?><br>
          </div>
          <?php } while ($row_Dessert = mysqli_fetch_assoc($Dessert)); ?>
          <br clear="all" />
        </div>
</div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        <h2 style="margin-bottom:0px;"><?php echo $row_Spirit['type']; ?></h2></div>
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><img src="images/logos/<?php echo $row_Spirit['bottle_img']; ?>" height=""  alt="" class="scalable"/></div>
          <a href="wines-detail.php?recordID=<?php echo $row_Spirit['code']; ?>"><?php echo $row_Spirit['wines']; ?></a><br>
          <?php echo $row_Spirit['type']; ?><br>
          <?php echo $row_Spirit['year']; ?><br>
          <?php echo $row_Spirit['producer']; ?><br>
        </div>
        <?php } while ($row_Spirit = mysqli_fetch_assoc($Spirit)); ?><br clear="all" />
      </div>
 </div>
  

      <!--<div class="country"><a href="producers-select.php?country=Dessert">Dessert</a></div>
        <div class="country"><a href="producers-select.php?country=Rose">Rose</a></div>
        <div class="country"><a href="producers-select.php?country=Spirit">Spirit</a></div>
        <div class="country"><a href="producers-select.php?country=White">White</a></div>
        <div class="country"><a href="producers-select.php?country=Sparkling">Sparkling</a></div>
    </div>-->
  </div>
...
<!-- InstanceEnd --></html>
<?php
((mysqli_free_result($Sparkling) || (is_object($Sparkling) && (get_class($Sparkling) == "mysqli_result"))) ? true : false);

((mysqli_free_result($Rose) || (is_object($Rose) && (get_class($Rose) == "mysqli_result"))) ? true : false);

((mysqli_free_result($Dessert) || (is_object($Dessert) && (get_class($Dessert) == "mysqli_result"))) ? true : false);

((mysqli_free_result($Spirit) || (is_object($Spirit) && (get_class($Spirit) == "mysqli_result"))) ? true : false);

((mysqli_free_result($Red) || (is_object($Red) && (get_class($Red) == "mysqli_result"))) ? true : false);
...
((mysqli_free_result($White) || (is_object($White) && (get_class($White) == "mysqli_result"))) ? true : false);
?>
