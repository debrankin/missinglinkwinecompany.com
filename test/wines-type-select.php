 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
    ...
    <div class="main-content-wide">
        <div class="content">  <div class="select-country-hdr">
  <h2 style="margin-top:0px;" id="<?php echo $row_Recordset1['type']; ?>"><?php echo $row_Recordset1['type']; ?></h2>
          ...
          <?php do { ?>
            <div class="wine-box">
              ...
              <a href="wines-detail.php?recordID=<?php echo $row_Recordset1['code']; ?>"><?php echo $row_Recordset1['wines']; ?></a><br><?php echo $row_Recordset1['producer']; ?></a><br>
