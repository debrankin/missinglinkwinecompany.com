...
<script type="text/javascript" src="http://s.sharethis.com/loader.js"></script><script src="SpryAssets/SpryAccordion.js" type="text/javascript"></script><!--The following script tag downloads a font from the Adobe Edge Web Fonts server for use within the web page. We recommend that you do not modify it.-->
...
<div class="AccordionPanel">
            ...
            <div class="AccordionPanelContent">
              <p>Menu <br>
                ...
                Wine importers<br>
                Winemakers</p>
              <p>eu, massa. Suspendisse potenti. Morbi commodo mauris. Ut at pede. Ut id nisi. Donec scelerisque urna quis ligula. Praesent est. Vestibulum scelerisque. Curabitur quam.<a href="#"> Fusce rhoncus </a>pellentesque ipsum. Aenean venenatis metus ac quam. Maecenas lacus lacus, sagittis vitae, congue at, euismod eu, urna. Maecenas vitae purus. Praesent </p>
            </div>
          </div>
          <div class="AccordionPanel">
            <div class="AccordionPanelTab">Calendar of Events</div>
            <div class="AccordionPanelContent">felis. Fusce a nisi in odio pulvinar fringilla. Nunc blandit interdum metus. Duis leo nunc, sollicitudin ut, fermentum congue, pharetra eu, massa. Suspendisse p</div>
          </div>
        </div>
      </div>
    </div>
    <div class="main-content">
      <div class="content p7ehc-1">
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><a href="#">eu, massa. Suspendisse potenti. Morbi </a>commodo mauris. Ut at pede. Ut id nisi. Donec scelerisque urna quis ligula. Praesent est. Vestibulum scelerisque. Curabitur quam. Fusce rhoncus pellentesque ipsum. Aenean venenatis metus ac quam. Maecenas lacus lacus, sagittis vitae, congue at, euismod eu, urna. Maecenas vitae purus. Praesent eros lectus, porta et, semper nec. Lorem ipsum <a href="#">dolor sit amet, consectetuer </a></p>
       <div class="fancylinks" ><p><a href="#">dolor sit amet, consectetuer </a></p></div>
        <p><a href="#"><img src="images/glass-icon.png" width="20" height="41"  alt=""/>dolor sit amet, consectetuer </a></p>
        <p><a href="#"><img src="images/glass-icon.png" width="20" height="41"  alt=""/>dolor sit amet, consectetuer </a></p>
        <h2>Resources </h2>
        <p>&nbsp;</p>
      </div>
