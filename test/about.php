...
<title>About Missing Link Wine Company</title>
<style type="text/css">
  ...
  <div class="columns-wrapper">
    <div class="main-content" style="text-align:center;">
      <div class="content p7ehc-1">
        <h2 style="margin-bottom:15px;">Who are We </h2>
        <div class="offsetbg" style="text-align:left;" id=b2>
          <div class="offsetbox">
            <div class="text-pad">
        ...
        <a href="#" class="tooltip">
          <h2>Thing #1</h2>
          <span class="custom info" style="text-align:left;"><img src="images/tt-will.png" alt="Information" height="63" width="49" /><em>Who am I?</em>Well, I'm the inspiration for my parents to do something to pay the bills - they like to feed me! Learn how you can help</span></a>
    ...
    <div class="main-content" style="text-align:center;">
    <div class="content p7ehc-1">
      <h2 style="margin-bottom:15px;">Proprieter</h2>
      <span class="ctr-img" ><img src="images/logos/doug-ann.png"  alt="" width="340" height="476"  class="scalable fancy" id="anndoug" onMouseOver="MM_swapImage('anndoug','','images/logos/doug-ann-clr.png',1)" onMouseOut="MM_swapImgRestore()"/></span><br>
      <div class="ctr-img" style="margin-top:10px;"></div>
      <h4>Doug Rankin & Ann Reynolds, Owners<br>
        <br>
      </h4>
      <span class="ctr-img" style="margin-top:10px;"></span> <a href="#" class="tooltip"> </a> <a href="#" class="tooltip">
        <h2>Thing #2</h2>
        <span class="custom info" style="text-align:left;"><img src="images/tt-ben.png" alt="Information" height="63" width="49" /><em>Who am I?</em>Well, I'm the inspiration for my parents to do something to pay the bills - they like to feed me! Learn how you can help</span></a>
...
<strong>Follow us on:</strong> </p>
          <a href="https://www.facebook.com/MissingLinkWineCompany">          </a>
        <a href="https://www.facebook.com/MissingLinkWineCompany">
