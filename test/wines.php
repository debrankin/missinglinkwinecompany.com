...
</div><?php } while ($row_Argentina = mysql_fetch_assoc($Argentina)); ?>
<br clear="all" /> </div>
          </div>
      ...
      <div style="margin-bottom:10px;" class="content">
        ...
        <?php } while ($row_Germany = mysql_fetch_assoc($Germany)); ?><br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        ...
        <?php } while ($row_Italy = mysql_fetch_assoc($Italy)); ?><br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        ...
        <?php } while ($row_Spain = mysql_fetch_assoc($Spain)); ?><br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        ...
        <?php } while ($row_USA = mysql_fetch_assoc($USA)); ?><br clear="all" />
...
mysql_free_result($type_menu);

mysql_free_result($Spain);
?>
