...
mysql_select_db($database_admin, $admin);
$query_AddCountry = "SELECT * FROM producers WHERE country LIKE '%ADD%' ORDER BY producer ASC";
$AddCountry = mysql_query($query_AddCountry, $admin) or die(mysql_error());
$row_AddCountry = mysql_fetch_assoc($AddCountry);
$totalRows_AddCountry = mysql_num_rows($AddCountry);
?>
<!doctype html>
  ...
  <div class="columns-wrapper">
    <div class="main-content" style="width:76%;">
      <div class="content p7ehc-1">
        <h2><?php echo $row_USA['country']; ?></h2>
        <?php do { ?>
         <div class="repeatregion"> 
           <div class="logo" style="width:20%;float:left;">LOGO <?php echo $row_Recordset1['logo']; ?></div>
          <div style="float:left; width:80%"> <?php echo $row_USA['producer']; ?><br>
          <br></div>
       <div style="width: 80%; float: left;">   <?php echo $row_USA['description']; ?></div>
          <p>&nbsp;</p></div>
          
          <p></p>
          <?php } while ($row_USA = mysql_fetch_assoc($USA)); ?>        
          <h2>
		  <?php echo $row_AddCountry['country']; ?></h2><br>
          <?php do { ?>
        <div class="repeatregion">   
          <div class="logo" style="width:20%;float:left;">LOGO <?php echo $row_Recordset1['logo']; ?></div>
        <div style="float:left; width:80%">   <?php echo $row_AddCountry['producer']; ?><br>
          <br>
        </div><br>
        <div style="width: 80%; float: left;">   <?php echo $row_AddCountry['description']; ?></div>
          <br></div>
         
<?php } while ($row_AddCountry = mysql_fetch_assoc($AddCountry)); ?>
<br>
      </div>
    </div>
    <div class="sidebar">
      <div class="content p7ehc-1">
        <h2>By Country</h2>
        <h2><a href="producers-select.php?country=USA&country=ADD%20COUNTRY">ALL</a></h2>
        <h2><a href="producers-select.php?country=USA">usa</a></h2>
        <p><a href="producers-select.php?country=ADD%20COUNTRY">add country</a></p>
        <p><a href="producers.php?country=France">France</a></p>
        <p><a href="producers.php?country=Spain">Spain</a></p>
        <p><a href="producers.php?country=Austria">Austria</a></p>
      </div>
    </div>
  </div>
