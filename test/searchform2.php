...
<div class="content-wrapper">  <div class="masthead">
 ...
 <a href="#"><img src="images/mlwc-logo-215w.png" alt="missing link wine companhy" width="264" height="160" class="scalable" onClick="P7_AP3control('p7AP3t3_1','trigger')"/></a>
  ...
  </div><div class="gs-mast"><form name="search" method="post" action="searchform2.php">
 Search for: 
...
if  ($field =="")
 {
 $data = mysql_query("SELECT * FROM sitesearch WHERE wine LIKE'%$find%' OR producer LIKE'%$find%' OR type LIKE'%$find%' OR description LIKE'%$find%'"); 
  //And we remind them what they searched for 
 echo "<b>Searched For:</b> " .$find; 
 } 
