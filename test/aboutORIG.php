...
<body onLoad="MM_preloadImages('images/redwine.png','images/redwine-op.png','images/logos/will-clr.png','images/logos/doug-ann-clr.png','images/logos/ben-clr.png','images/3glasses2.png')">
    ...
    <div id="p7AP3c3_1" class="p7AP3content p7ap3-theme-01">
      <div id="p7AP3p3_1" class="p7AP3panelcontent p7ap3-theme-01" style="border-radius:0px;">
        <div class="p7ap3-col-wrapper no-columns" >
          <p>Contact info: doug@missinglinkwineco.com - 203 807 1199</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="menu-top-wrapper">
      <div id="p7DMM_1" class="p7DMM01 p7DMM p7dmm-centered responsive">
        ...
        <ul id="p7DMMu_1" class="p7DMM01-menu closed">
          <li><a id="p7DMMt1_1" href="index.php"><img src="images/home.png" width="30" height="26" alt="home"/></a>
          ...
          <li><a id="p7DMMt1_2" href="about.php"><img src="images/about.png" width="30" height="26" alt="about us"/></a>
          ...
          <li><a id="p7DMMt1_3" href="wines.php"><img src="images/wines2.png" width="30" height="26" alt="wines"/></a>
          ...
          <li><a id="p7DMMt1_4" href="producers.php"><img src="images/estate.png" width="30" height="26" alt="Producers"/></a>
         ...
         <!-- <li><a id="p7DMMt1_5" href="#">Customer Service</a></li>-->
          <li><a href="#"><img src="images/phone2.png" alt="contact us" width="30" height="26" onClick="P7_AP3control('p7AP3t3_1','trigger')"/></a></li>
        </ul>
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="main-content">
      <div class="content p7ehc-1">
       <a href="#" class="tooltip"> <h2>Thing #1</h2><span class="custom info"><img src="images/tt-will.png" alt="Information" height="63" width="49" /><em>Who am I?</em>Well, I'm the inspiration for my parents to do something to pay the bills - they like to feed me! Learn how you can help</span></a>
        ...
        <em>Will, Ben's manage</em>r        </h4>
        <p>&nbsp;</p>
        <h2>Proprieters<br>
        </h2>
              
     <div class="ctr-img" style="margin-top:10px;"><img src="images/logos/doug-ann.png"  alt="" width="340" height="476"  class="scalable fancy" id="anndoug" onMouseOver="MM_swapImage('anndoug','','images/logos/doug-ann-clr.png',1)" onMouseOut="MM_swapImgRestore()"/><br>
     </div>
     <div class="offsetbg" id=b2>
          <div class="offsetbox">
            <div class="text-pad">
              <p>Doug and Ann began this company a little while ago. So far so good. We need you to help support our family so please buy our wines. Thank you.<a href="#b2"></a></p>
            </div>
          </div>
        </div>
        <p>&nbsp;</p>
    ...
    <div class="main-content">
      <div class="content p7ehc-1">
        <a href="#" class="tooltip"> <h2>Thing #2</h2><span class="custom info"><img src="images/tt-ben.png" alt="Information" height="63" width="49" /><em>Who am I?</em>Well, I'm the inspiration for my parents to do something to pay the bills - they like to feed me! Learn how you can help</span></a>
        ...
        <div class="ctr-img" style="margin-top:10px;"> <img src="images/logos/ben-bw.png"  alt="" width="340" height="476"  class="scalable fancy" id="ben" onMouseOver="MM_swapImage('ben','','images/logos/ben-clr.png',1)" onMouseOut="MM_swapImgRestore()"/> </div>
          ...
          <p>&nbsp;</p>
          <h2>Where are we</h2>
          <div class="offsetbg" id=cl>
            <div class="offsetbox">
              <div class="text-pad">
                <p><a href="#cl">right here in Clonesville, ct</a></p>
              </div>
            </div>
          </div>
          <h2>Resources </h2>
        <div class="offsetbg">
          <div class="offsetbox">
            <div class="text-pad">
              <p>felis. Fusce a nisi in odio pulvinar fringilla. Nunc blandit interdum metus. Duis leo nunc, sollicitudin ut, fermentum congue, pharetra eu, massa. Suspendisse peu, massa.  </p>
            </div>
          </div>
        </div>
        <p>&nbsp;</p>
    ...
    <div class="sidebar">
      <div class="content p7ehc-1">
        <h2 style="font-family:Tangerine; font-size:3em;">Featured Wine</h2>
