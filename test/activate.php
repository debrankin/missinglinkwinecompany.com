...
<Option VALUE="producer">Producer</option>
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
    <div class="main-content" style="width:67%;">
      <div class="content p7ehc-1">
       <h2>Activate your account</h2>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <p>Hi <strong><?php echo $row_rsActivate['name']; ?></strong>. Please activate your account clicking <input type="submit" value="Activate my account" />
        <input type="hidden" name="level" value="1" />
        <input type="hidden" name="MM_update" value="form1" />
        <input type="hidden" name="activation" value="<?php echo $row_rsActivate['activation']; ?>" />
      </p>
      <p>Thank you for your interest in Missing Link Wine Company. Please feel free to contact us if you have any questions, suggestions, rants, or just want to spend a few moments philosophizing!</p>
    </form>
      </div>
    </div>
    <div class="sidebar">
