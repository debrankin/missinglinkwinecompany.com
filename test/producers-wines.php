...
$rs_wines = mysql_query($query_rs_wines, $admin) or die(mysql_error());
$row_rs_wines = mysql_fetch_assoc($rs_wines);
$totalRows_rs_wines = mysql_num_rows($rs_wines);$colname_rs_wines = "-1";
if (isset($_GET['recordsetPRODUCER'])) {
  $colname_rs_wines = $_GET['recordsetPRODUCER'];
}
mysql_select_db($database_admin, $admin);
...
$rs_wines = mysql_query($query_rs_wines, $admin) or die(mysql_error());
$row_rs_wines = mysql_fetch_assoc($rs_wines);
$totalRows_rs_wines = mysql_num_rows($rs_wines);
?>
<!doctype html>
        ...
        <div class="content p7ehc-1">
          ...
          <?php do { ?>
            <div class="repeatregion">
              ...
              <div class="wines-details"><?php echo $row_rs_wines['description']; ?></div>
              <p><br clear="all" />
              </p>
            </div>
            <?php } while ($row_rs_wines = mysql_fetch_assoc($rs_wines)); ?>
