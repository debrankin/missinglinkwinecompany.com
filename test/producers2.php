...
mysql_select_db($database_admin, $admin);
$query_country_menu = "SELECT country FROM producers ORDER BY country ASC";
...
<div class="content-wrapper">  <div class="masthead">
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
    <div class="main-content" style="width:76%;">
      <div style="margin-bottom:10px;" class="content">
      
       <h2 style="margin-bottom:20px;"><?php echo $row_Argentina['country']; ?></h2>
        <?php do { ?>
         <div class="repeatregion"> 
           <div class="producer"><?php echo $row_Argentina['producer']; ?></div>
<div class="lable"><a href="#"><img src="images/<?php echo $row_Argentina['id']; ?>.png" height=""  alt="" class="scalable"/></a> </div>
      ...
      <div style="margin-bottom:10px;" class="content">
        <h2 style="margin-bottom:20px;"><?php echo $row_France['country']; ?></h2>
        <?php do { ?>
        <div class="repeatregion">
          <div class="country-name"><?php echo $row_France['producer']; ?></div>
          <div class="label"><a href="#"><img src="images/<?php echo $row_France['id']; ?>.png" height=""  alt="" class="scalable"/></a></div>
      ...
      <div style="margin-bottom:10px;" class="content">
        <h2 style="margin-bottom:20px;"><?php echo $row_Germany['country']; ?></h2>
        <?php do { ?>
        <div class="repeatregion">
          <div class="country-name"><?php echo $row_Germany['producer']; ?></div>
          <div class="logo"><a href="#"><img src="images/<?php echo $row_Germany['id']; ?>.png" height=""  alt="" class="scalable"/></a></div>
      ...
      <div style="margin-bottom:10px;" class="content">
        <h2 style="margin-bottom:20px;"><?php echo $row_Italy['country']; ?></h2>
        <?php do { ?>
        <div class="repeatregion">
          <div class="country-name"><?php echo $row_Italy['producer']; ?></div>
          <div class="logo"><a href="#"><img src="images/<?php echo $row_Italy['id']; ?>.png" height=""  alt="" class="scalable"/></a></div>
      ...
      <div style="margin-bottom:10px;" class="content">
        <h2 style="margin-bottom:20px;"><?php echo $row_Spain['country']; ?></h2>
        <?php do { ?>
        <div class="repeatregion">
          <div class="country-name"><?php echo $row_Spain['producer']; ?></div>
          <div class="logo"><a href="#"><img src="images/<?php echo $row_Spain['id']; ?>.png" height=""  alt="" class="scalable"/></a></div>
      ...
      <div style="margin-bottom:10px;" class="content">
        <h2 style="margin-bottom:20px;"><?php echo $row_USA['country']; ?></h2>
        <?php do { ?>
        <div class="repeatregion">
          <div class="country-name"><?php echo $row_USA['producer']; ?></div>
          <div class="logo"><a href="#"><img src="images/<?php echo $row_USA['id']; ?>.png" height=""  alt="" class="scalable"/></a></div>
    ...
    <div class="sidebar">
      <div class="content p7ehc-1">
        ...
        <h3><a href="producers.php">ALL</a></h3><h2>By Country</h2>
        <div class="country"><a href="producers-select.php?country=Argentina">Argentina</a></div>
