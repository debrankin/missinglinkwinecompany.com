...
$('img').error(function(){
        $(this).attr('src', '<?php echo $row_type_menu['flag']; ?>.png');
});
...
$("img").error(function(){
  ...
  <div class="columns-wrapper">    <div class="sidebar" id="clinks">
      <div class="content p7ehc-1">
        <h2>By Color</h2><div class="prod-menu" style="margin-top:20px;">   <div class="country" ><a href="wines.php">ALL</a></div>
        <div class="flag"><a href="producers.php"><img src="images/peace2.png" width="23" height="17"  alt=""/></a></div><div class="clearfloat"></div></div>
        
        <?php do { ?>
  <div class="prod-menu">   <div class="country"><a href="wines-select.php?recordID=<?php echo $row_type_menu['type']; ?>"><?php echo $row_type_menu['type']; ?></a></div>
        <div class="flag"><a href="producers-select.php?type=<?php echo $row_type_menu['icon']; ?>"><img src="images/<?php echo $row_type_menu['icon']; ?>.png" width="25" height="17"  alt=""/></a></div><div class="clearfloat"></div></div>
 ...
 <div class="main-content-wide">
  ...
  <h2 style="margin-top:0px;"><?php echo $row_Red['type']; ?></h2>
        </div>
        
         <div class="wine-container"><?php do { ?>
<div class="wine-box"><div class="wine-blt"><a href="#"><img src="images/logos/<?php echo $row_Red['bottle_img']; ?>.png" height=""  alt="" class="scalable"/></a></div> <a href="wines-detail.php?recordID=<?php echo $row_Red['code']; ?>"><?php echo $row_Red['wines']; ?></a><br> <?php echo $row_Red['type']; ?><br>
            <?php echo $row_Red['year']; ?>
            <?php echo $row_Red['producer']; ?><br>
</div><?php } while ($row_Red = mysql_fetch_assoc($Red)); ?>
<br clear="all" /> </div>
          </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        ...
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><a href="#"><img src="images/logos/<?php echo $row_White['bottle_img']; ?>.png" height=""  alt="" class="scalable"/></a></div>
        ...
        <?php } while ($row_White = mysql_fetch_assoc($White)); ?>
        <br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        ...
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><a href="#"><img src="images/logos/<?php echo $row_Rose['bottle_img']; ?>.png" height=""  alt="" class="scalable"/></a></div>
        ...
        <?php } while ($row_Rose = mysql_fetch_assoc($Rose)); ?>
        <br clear="all" />
      </div>
      <div style="margin-bottom:10px;" class="content">
        <div class="select-country-hdr">
        ...
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><a href="#"><img src="images/logos/<?php echo $row_Sparkling['bottle_img']; ?>.png" height=""  alt="" class="scalable"/></a></div>
        ...
        <?php } while ($row_Sparkling = mysql_fetch_assoc($Sparkling)); ?>
        <br clear="all" />
      </div>
      ...
      <div style="margin-bottom:10px;" class="content"><div class="select-country-hdr">
        ...
        <div class="wine-container">
          <?php do { ?>
          <div class="wine-box">
            <div class="wine-blt"><a href="#"><img src="images/logos/<?php echo $row_Dessert['bottle_img']; ?>.png" height=""  alt="" class="scalable"/></a></div>
          ...
          <?php } while ($row_Dessert = mysql_fetch_assoc($Dessert)); ?>
          <br clear="all" />
        </div>
</div>
      <div style="margin-bottom:10px;" class="content">
        ...
        <?php do { ?>
        <div class="wine-box">
          <div class="wine-blt"><a href="#"><img src="images/logos/<?php echo $row_Spirit['bottle_img']; ?>.png" height=""  alt="" class="scalable"/></a></div>
        ...
        <?php } while ($row_Spirit = mysql_fetch_assoc($Spirit)); ?><br clear="all" /><div id="backtotop">&gt; Back to top</div>
      </div>
 </div>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($Sparkling);

mysql_free_result($Rose);

mysql_free_result($Dessert);

mysql_free_result($Spirit);

mysql_free_result($Red);

mysql_free_result($type_menu);

mysql_free_result($White);
?>
