...
$query_Recordset1 = "SELECT * FROM wines ORDER BY ".mysql_real_escape_string($orderby);
...
$query_Recordset1 = "SELECT * FROM wines ORDER BY wines ASC"; }
 ...
 <input type="submit" name="search" value="Search" />
  ...
  <div class="columns-wrapper">
    <div class="main-content-wide" style="width:98%;">
      ...
      <div class="select-country-hdr"><div class="log"> <a href="<?php echo $logoutAction ?>">Log Out</a></div>
  <h2 style="margin-top:0px;">Price List</h2>
       ...
       <div class="price-rows">  <div class="price-cols-first" style="height:auto;">
         <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=wines&sortby=$newsort";?>">		Wine <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
       </div>
         <div class="price-cols-prod" style="height:auto;">
           <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=producer&sortby=$newsort";?>">		Producer <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
         </div><div class="price-cols" style="height:auto;">
              <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=year&sortby=$newsort";?>">Year <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
            </div>
           &nbsp;
            <div class="price-cols" style="height:auto;">
              <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=type&sortby=$newsort";?>">Type <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
            </div>
           &nbsp;
           <div class="price-cols" style="height:auto;">
             <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=ML&sortby=$newsort";?>">ML <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
         </div>
           <div class="price-cols-last" style="height:auto;"> 
              <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=CASE_cost&sortby=$newsort";?>">		Case <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
            </div>
           <div class="price-cols-btl" style="height:auto;">
             <h4><a href="<? echo $_SERVER['PHP_SELF']."?orderby=BTL_cost&sortby=$newsort";?>"> Bottle <img src="images/sort.png" width="12" height="18"  alt=""/></a></h4>
           </div>
          ...
          <div class="price-rows">  <div class="price-cols-first"><a href="#"><?php echo $row_Recordset1['wines']; ?></a></div>
            <div class="price-cols-prod"><?php echo $row_Recordset1['producer']; ?></div><div class="price-cols"><?php echo $row_Recordset1['year']; ?></div>
            <div class="price-cols"><?php echo $row_Recordset1['type']; ?></div>
           &nbsp; 
           <div class="price-cols"><?php echo $row_Recordset1['ML']; ?></div>
           <div class="price-cols-last"> <?php echo $row_Recordset1['BTLS']; ?> btls - <?php echo $row_Recordset1['CASE_cost']; ?></div>
           <div class="price-cols-btl"><?php echo $row_Recordset1['BTL_cost']; ?></div>
